        ...
        <ul class="nav">
            ...
            <li class="has-sub">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="../../frontend/e-commerce/template_content_html/index.html"
            ...
            <li class="has-sub">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="../template_content_angularjs4/index.html">ANGULAR JS 4 <i
                                    class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
                    <li><a href="../template_content_material/index.html">MATERIAL DESIGN</a></li>
                    <li><a href="../template_content_apple/index.html">APPLE DESIGN <i
                                    class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
                </ul>
            </li>
            <li class="has-sub">
